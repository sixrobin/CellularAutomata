namespace CellularAutomata
{
    ...
    public class CellularAutomaton3D : CellularAutomaton
    {
        ...
        private static readonly int COLOR_MODE_SHADER_ID = Shader.PropertyToID("_ColorMode");
        ...
        protected override void Init()
        {
            ...
            this._material.SetFloat(COLOR_MODE_SHADER_ID, (int)this._settings.ColorMode);
        }
